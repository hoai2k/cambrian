...
| T3D-02b | **active** | `/root/throat_audit` | Extend Hupehsuchus' jaw to the full lip and keep the posterior jaw attached to its pouch. | Paired exported-body audit and 61-phase/all-clip shared-rim check; final portrait packaging underway. |
