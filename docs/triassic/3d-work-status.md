...
| T3D-12 | **pending** | unclaimed | Recover the six custom oral builders still shipping mixed jaw/skull sacs: Dinocephalosaurus, Hybodus, Keichousaurus, Phragmoteuthis, Placodus and Saurichthys. Port preserved-branch deltas onto current builders without reversing newer skinning/Grab fixes; remove Phragmoteuthis' invented crown opening as documented. No regeneration. | Before work, claim a bounded batch. Rebuild authored/puppet/LOD assets; refresh portraits, paired/all-clip audits and SHA-bound topology/visual evidence. This batch has not started and is gated by the user's remaining-usage preference for new Astra work. |
