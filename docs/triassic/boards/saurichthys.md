# T15 · *Saurichthys* — reference board
...
| Field | Working value |
| --- | --- |
| Representative length | **1 m** (maximum recorded in the swimming dataset: 1.5 m) |
| Existing catalogue range | 0.6–1.5 m |
| Age / locality context | Widespread Triassic; the design draws especially on Muschelkalk and South China occurrences. |
...
![Current canonical pose](../canonical/saurichthys.png)
...
![Catalogue evidence thumbnail](https://thumb.wikimedia.org/wikipedia/commons/thumb/1/17/Saurichthys_fossil.jpg/960px-Saurichthys_fossil.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail)

**Catalogue evidence:** [Saurichthys fossil.jpg](https://commons.wikimedia.org/wiki/File:Saurichthys_fossil.jpg) — Tiia Monto, CC BY-SA 3.0. saurichthys fossil in Bündner Naturmuseum, Chur.
...
- **Model target:** Three scale rows, large eye, and opposed fins set far back on a slender body.
