# T13 · *Mixosaurus cornalianus* — reference board
...
| Field | Working value |
| --- | --- |
| Representative length | **1 m** (maximum recorded in the swimming dataset: 2 m) |
| Existing catalogue range | 0.7–2 m |
| Age / locality context | Besano Formation, Monte San Giorgio and Besano; Anisian–Ladinian boundary. |
...
![Current canonical pose](../canonical/mixosaurus.png)
...
![Catalogue evidence thumbnail](https://thumb.wikimedia.org/wikipedia/commons/thumb/d/d4/Mixosaurus_under_the_Besanosaurus_slab.JPG/960px-Mixosaurus_under_the_Besanosaurus_slab.JPG?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail)

**Catalogue evidence:** [Mixosaurus under the Besanosaurus slab.JPG](https://commons.wikimedia.org/wiki/File:Mixosaurus_under_the_Besanosaurus_slab.JPG) — Ghedoghedo, CC BY-SA 4.0. Fossil of Mixosaurus- Museo di Storia Naturale di Milano
...
- **Model target:** Dorsal fin, dorsal tail lobe and heterodont teeth.
