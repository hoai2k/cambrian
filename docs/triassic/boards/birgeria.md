# T11 · *Birgeria stensioei* — reference board
...
| Field | Working value |
| --- | --- |
| Representative length | **1.8 m** (maximum recorded in the swimming dataset: 2.2 m) |
| Existing catalogue range | 1–2 m |
| Age / locality context | Early–Middle Triassic marine deposits including Spitsbergen and Monte San Giorgio. |
...
![Current canonical pose](../canonical/birgeria.png)
...
![Catalogue evidence thumbnail](https://thumb.wikimedia.org/wikipedia/commons/thumb/3/3e/Birgeria_stensioei_skeleton.jpg/960px-Birgeria_stensioei_skeleton.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail)

**Catalogue evidence:** [Birgeria stensioei skeleton.jpg](https://commons.wikimedia.org/wiki/File:Birgeria_stensioei_skeleton.jpg) — Neil Pezzoni, CC BY 4.0. PIMUZ T 5, a complete skeleton of Birgeria stensioei. The specimen was found at Valle Stelle, an outcrop on Monte San Giorgio preserving the late Anisian (Middle Triassic) Besano Formation. Photo taken at the Museo dei fossili di Meride in Meride, Switzerland.
...
- **Model target:** Scaleless tuna-shaped body, large head, wide gape and deeply forked tail.
