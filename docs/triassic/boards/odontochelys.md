# T19 · *Odontochelys semitestacea* — reference board
...
| Field | Working value |
| --- | --- |
| Representative length | **40 cm** (maximum recorded in the swimming dataset: 40 cm) |
| Existing catalogue range | ~40 cm |
| Age / locality context | Xiaowa Formation, Guanling, Guizhou; Carnian. |
...
![Current canonical pose](../canonical/odontochelys.png)
...
![Catalogue evidence thumbnail](https://thumb.wikimedia.org/wikipedia/commons/thumb/b/b8/Odontochelys_semitestacea_Holotype_IVPP.jpg/960px-Odontochelys_semitestacea_Holotype_IVPP.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail)

**Catalogue evidence:** [Odontochelys semitestacea Holotype IVPP.jpg](https://commons.wikimedia.org/wiki/File:Odontochelys_semitestacea_Holotype_IVPP.jpg) — Jonathan Chen, CC BY-SA 4.0. Holotype skeleton (IVPP V 15639) of Odontochelys semitestacea on display at the Paleozoological Museum of China.
...
- **Model target:** Teeth, no carapace, broadened ribs, long tail and a ventral plastron.
