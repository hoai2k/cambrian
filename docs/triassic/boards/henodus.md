# T14 · *Henodus chelyops* — reference board
...
| Field | Working value |
| --- | --- |
| Representative length | **1 m** (maximum recorded in the swimming dataset: 1 m) |
| Existing catalogue range | ~1 m |
| Age / locality context | Oberer Gipskeuper at Tübingen-Lustnau; early Carnian. |
...
![Current canonical pose](../canonical/henodus.png)
...
![Catalogue evidence thumbnail](https://thumb.wikimedia.org/wikipedia/commons/thumb/c/c4/Henodus_skeleton_AMNH.jpg/960px-Henodus_skeleton_AMNH.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail)

**Catalogue evidence:** [Henodus skeleton AMNH.jpg](https://commons.wikimedia.org/wiki/File:Henodus_skeleton_AMNH.jpg) — Ryan Schwark, CC0. Skeleton of Henodus at the American Museum of Natural History
...
- **Model target:** Square shell of many plates, fringed lip and ventral plastron.
