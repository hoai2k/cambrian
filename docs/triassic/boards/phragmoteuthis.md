# T21 · *Phragmoteuthis bisinuata* — reference board
...
| Field | Working value |
| --- | --- |
| Representative length | **40 cm** (maximum recorded in the swimming dataset: 50 cm) |
| Existing catalogue range | 20–30 cm |
| Age / locality context | Polzberg/Lunz, Lower Austria; Carnian. |
...
![Current canonical pose](../canonical/phragmoteuthis.png)
...
![Catalogue evidence thumbnail](https://thumb.wikimedia.org/wikipedia/commons/thumb/2/22/Phragmoteuthis_conocauda_923.jpg/960px-Phragmoteuthis_conocauda_923.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail)

**Catalogue evidence:** [Phragmoteuthis conocauda 923.jpg](https://commons.wikimedia.org/wiki/File:Phragmoteuthis_conocauda_923.jpg) — Ghedoghedo, CC BY-SA 4.0. Fossil of Phragmoteuthis- Took the picture at Museum am Lowentor, Stuttgart
...
- **Model target:** Rigid internal shell, broad pro-ostracum and paired arm hooks.
