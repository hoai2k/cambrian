# T09 · *Placodus gigas* — reference board
...
| Field | Working value |
| --- | --- |
| Representative length | **2.5 m** (maximum recorded in the swimming dataset: 3 m) |
| Existing catalogue range | 2–3 m |
| Age / locality context | Muschelkalk of central Europe; Anisian–Ladinian. |
...
![Current canonical pose](../canonical/placodus.png)
...
![Catalogue evidence thumbnail](https://thumb.wikimedia.org/wikipedia/commons/thumb/0/03/Placodus_skeleton_Zurich.jpg/960px-Placodus_skeleton_Zurich.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail)

**Catalogue evidence:** [Placodus skeleton Zurich.jpg](https://commons.wikimedia.org/wiki/File:Placodus_skeleton_Zurich.jpg) — NGPezz, CC BY 4.0. A reconstructed skeletal mount of Placodus gigas, displayed at the Paleontological Museum of Zurich.
...
- **Model target:** Barrel body; procumbent incisors; crushing palate; gastral basket.
