# T06 · *Rhaeticosaurus mertensi* — reference board
...
| Field | Working value |
| --- | --- |
| Representative length | **3 m** (maximum recorded in the swimming dataset: 3.5 m) |
| Existing catalogue range | ~2.4 m+ |
| Age / locality context | Exter Formation at Bonenburg, Westphalia; Rhaetian. |
...
![Current canonical pose](../canonical/rhaeticosaurus.png)
...
- **Model target:** Pliosaurid-grade short neck, large head, four hydrofoils, barrel trunk and short tail.
