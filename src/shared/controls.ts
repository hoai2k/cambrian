...
const LABELS: Record<Action, Label> = {
  ...
  sink:     { pad: 'LB', kbm: 'C', key1: 'C', key2: 'M' },
  light:    { pad: 'Y', kbm: 'F', key1: 'F', key2: ';' },
  heavy:    { pad: 'RT', kbm: 'Left click', key1: 'G', key2: '’', short: { kbm: 'LMB' } },
  ability:  { pad: 'D-pad right', kbm: 'R', key1: 'R', key2: 'P', short: { pad: '▶' } },
  dash:     { pad: 'X', kbm: 'Right click', key1: 'V', key2: '/', short: { kbm: 'RMB' } },
