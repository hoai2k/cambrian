...
/**
 * Body mass, in arbitrary units — every use is a ratio between two animals. Cubed *length*, not
 * cubed scale: scale is a fraction of the animal's own adult size, and now that the roster spans
 * real lengths (docs/research/cambrian-sizes.md) two creatures at scale 1 are nothing like the
 * same mass.
 */
export const massOf = (a: Actor) => lengthOf(a) ** 3;
