...
export function devActor(g: Game, a: Actor): DevActor {
  ...
  if (!d) {
    d = { standing: 0, stage: 0, air: 1, gulpT: 0, inRange: false, rangeT: 0, beached: false, deadT: 0, deadZoneIn: false, moultSoft: 0, exuvia: -1, exuviaT: 0, followers: 0, sinceGain: 0, sinceEat: 0, dominantT: 0, recent: [], openT: 0, bluffed: new Map() };
    s.actors.set(a.id, d);
  }
  return d;
}
