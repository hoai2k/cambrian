        ...
        <div className="dialog-body">
          ...
          <div className="help-columns">
            ...
            <section>
              ...
              <h3>Keyboard</h3>
              <p><b>1:</b> WASD swim · arrows look · Shift burst · Space rise · C sink · F bite · G heavy · R ability · V dodge · Q guard · Tab lock · E sense · Esc pause.<br /><b>2:</b> IJKL swim · Right Shift burst · N rise · M sink · ; bite · ' heavy · P ability · / dodge · U guard · O lock · Y sense.</p>
            </section>
          </div>
        </div>
      )}
