...
const SETTINGS_FIELDS: Field[] = [
  ...
  { kind: 'toggle', key: 'shoreAnimals', label: 'Shore animals', note: 'Puts the shore animals on the beach (src/sim/triassic/shore.ts): they come and go, and take what holds still at the edge of the water or on the sand. Triassic only, off by default, and live: turned on mid-match the banks fill, turned off every body on the beach leaves.' },
