...
export const DEVONIAN = defineEra({
  ...
  copy: { tagline: 'Feed. Grow. Fight. Escape.', taglineEm: '375 million years ago, the sea had a pecking order.', loading: 'FILLING THE BASIN…', lose: 'THE SEA WINS', settingsKey: 'devonian-settings', mobileIllustration: DEVONIAN_BRAND_EXTRAS.mobileIllustration, sibling: { title: 'Cambrian Conquest', path: '', blurb: '133 million years earlier', logo: 'assets/brand/logo-engraved.webp' }, siblings: [{ title: 'Triassic Triumph', path: 'triassic/', blurb: '135 million years later', logo: 'assets/triassic/brand/logo-triassic-compact.png' }] },
  modes: [
