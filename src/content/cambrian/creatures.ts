...
export const CAMBRIAN_CREATURES: readonly CreatureDef[] = [
  {
    ...
    role: 'Pursuit predator', ground: false, adultLength: 6.25,
    speed: 8.97, burst: 1.9, agility: 3.0, turnRate: 2.2, glide: 0.55,
    hp: 202, poise: 92, stamina: 110, defense: 0.06, sense: 14,
  ...
  },
  {
    ...
    role: 'Reach specialist', ground: false, adultLength: 1.97,
    speed: 3.09, burst: 1.7, agility: 3.6, turnRate: 2.8, glide: 0.8,
    hp: 57, poise: 28, stamina: 100, defense: 0.05, sense: 11,
  ...
  },
  {
    ...
    role: 'Skirmisher', tailFlip: true, ground: false, adultLength: 2.17,
    speed: 5.3, burst: 2.2, agility: 5.0, turnRate: 3.6, glide: 1.6,
    hp: 61, poise: 24, stamina: 120, defense: 0.03, sense: 10,
  ...
  },
  {
    ...
    role: 'Controller', ground: false, adultLength: 1.37,
    speed: 2.64, burst: 1.7, agility: 4.0, turnRate: 3.2, glide: 0.9,
    hp: 39, poise: 18, stamina: 100, defense: 0.08, sense: 9,
  ...
  },
  {
    ...
    role: 'Fortress', weedWalk: true, cling: true, ground: true, adultLength: 1.22, diet: 'scavenger',
    speed: 1.49, burst: 1.6, agility: 5.0, turnRate: 2.6, glide: 3.0,
    hp: 50, poise: 33, stamina: 95, defense: 0.3, sense: 8,
  ...
  },
  {
    ...
    role: 'Tank', cling: true, ground: true, adultLength: 1.37, diet: 'grazer', grazeStill: true,
    speed: 1.58, burst: 1.5, agility: 4.0, turnRate: 2.2, glide: 3.5,
    hp: 79, poise: 54, stamina: 90, defense: 0.42, sense: 7,
  ...
  },
  {
    ...
    role: 'Scout', weedWalk: true, ground: true, adultLength: 0.92, diet: 'deposit',
    speed: 1.7, burst: 1.9, agility: 6.0, turnRate: 3.8, glide: 2.5,
    hp: 26, poise: 12, stamina: 115, defense: 0.12, sense: 16,
  ...
  },
  {
    ...
    role: 'Bruiser', weedWalk: true, ground: true, adultLength: 2.27,
    speed: 2.72, burst: 1.7, agility: 4.5, turnRate: 2.4, glide: 3.0,
    hp: 110, poise: 74, stamina: 100, defense: 0.38, sense: 8,
