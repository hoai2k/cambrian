import NATURAL_SIZES from './natural-sizes.json';
...
export const CAMBRIAN = defineEra({
  ...
  copy: { tagline: 'Eat. Grow. Fight. Run.', taglineEm: '508 million years ago, everything was hungry.', loading: 'WAKING THE REEF…', lose: 'THE REEF WINS', settingsKey: 'cambrian-settings', sibling: { title: 'Devonian Domination', path: 'devonian/', blurb: '133 million years later', logo: 'assets/devonian/brand/logo-engraved.webp' }, siblings: [{ title: 'Triassic Tide', path: 'triassic/', blurb: '268 million years later', logo: 'assets/triassic/brand/logo.svg' }] },
  modes: [
  ...
  // What the roster plays at; Settings → Equivalent sizing puts the flat lengths above back.
  // Generated by `npm run cambrian:sizes`; see the field's note on EraDefinition and
