import EQUIVALENT_SIZING from './equivalent-sizing.json';
...
export const CAMBRIAN = defineEra({
  ...
  // Settings → Equivalent sizing. Generated by `npm run cambrian:sizes`; see the field's note on
  // EraDefinition and docs/research/cambrian-sizes.md.
  equivalentSizing: EQUIVALENT_SIZING.sizes,
  defaults: {
    player: 'anomalocaris',
