...
export const SHARED_STRINGS: GameStrings = {
  ...
  sim: {
    ...
    hide: {
      ...
      matchRock: 'Rock',
      burrowDescription: '{ability}: descend and bury in sediment without stamina drain. {ability} or heavy exits with a free emergence strike.',
      camouflageDescription: '{ability}: copy the nearest creature, plant, rock or seafloor colour. Uses stamina; idle creatures slowly sink. Move to counter sinking; attack, block or sprint reveals you.',
    },
    ladder: {
    ...
    hints: {
      ...
      hide: '{ability}: hide. Burrowers bury for free; camouflage copies nearby colours and uses stamina.',
