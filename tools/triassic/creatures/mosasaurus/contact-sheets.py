"""Assemble the review sheets from the renders of the exported Mosasaurus GLB.
...
S.build('mosasaurus', {
    ...
    'review-swim-sheet': ['Swim-0', 'Swim-0.22', 'Swim-0.45', 'Swim-0.68',
                          'Sprint-0', 'Sprint-0.12', 'Sprint-0.25', 'Sprint-0.38',
                          'Swim-0-top', 'Swim-0.22-top', 'Swim-0.45-top', 'Swim-0.68-top',
                          'Sprint-0-top', 'Sprint-0.12-top', 'Sprint-0.25-top',
                          'Sprint-0.38-top'],
    'review-charge-sheet': ['Ability-0.15', 'Ability-0.35', 'Ability-0.55', 'Ability-0.8',
    ...
    'review-actions-sheet': ['Hit-0.3', 'Stagger-0.6', 'Guard-0.6', 'Parry-0.2', 'Dodge-0.25',
                             'Eat-0.3', 'Eat-0.6', 'Death-1.4', 'Grab-0.55', 'Breath-1.2',
                             'Breathe-1.5', 'Growth-0.75'],
    'review-mouth-sheet': ['mouth-Idle-0', 'mouth-below-Idle-0', 'mouth-Bite-0.12',
                           ...
                           'mouth-Eat-0.3', 'mouth-below-Eat-0.3']})
