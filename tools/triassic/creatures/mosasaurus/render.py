"""Render the exported Mosasaurus: the clips at chosen phases, the diagnostic views and the mouth,
from the re-imported GLB rather than from the authoring scene.

  /opt/blender/blender -b --factory-startup --python tools/triassic/creatures/mosasaurus/render.py \
      -- [--decoded] [--twin] [--mouth-only] [--portraits]

Portraits go into this directory's `portraits/`, never into `public/assets/`: Mosasaurus is off the
...
PHASES = [('Idle', 0), ('Swim', 0), ('Swim', 0.22), ('Swim', 0.45), ('Swim', 0.68),
          ('Sprint', 0), ('Sprint', 0.12), ('Sprint', 0.25), ('Sprint', 0.38),
          ...
          ('Guard', 0.6), ('Parry', 0.2), ('Dodge', 0.25), ('Eat', 0.3), ('Eat', 0.6),
          ('Stagger', 0.6), ('Grab', 0.55), ('Breath', 1.2), ('Breathe', 1.5), ('Growth', 0.75)]
TOP = [('Swim', 0), ('Swim', 0.22), ('Swim', 0.45), ('Swim', 0.68),
       ('Sprint', 0), ('Sprint', 0.12), ('Sprint', 0.25), ('Sprint', 0.38),
       ('Ability', 0.15), ('Ability', 0.35), ('Ability', 0.55), ('Ability', 0.8)]
MOUTH = [('Idle', 0), ('Bite', 0.12), ('Heavy', 0.5), ('Eat', 0.3)]

C.run('mosasaurus', PHASES, TOP, MOUTH, mouth_scale=1.3)
