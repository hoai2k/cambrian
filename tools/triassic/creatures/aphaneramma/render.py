"""Render the exported Aphaneramma: the clips at chosen phases, the diagnostic views and the
mouth, from the re-imported GLB rather than from the authoring scene.

  /opt/blender/blender -b --factory-startup --python tools/triassic/creatures/aphaneramma/render.py \
...
PHASES = [('Idle', 0), ('Swim', 0), ('Swim', 0.24), ('Swim', 0.48), ('Swim', 0.72),
          ('Sprint', 0), ('Sprint', 0.14), ('Sprint', 0.28), ('Sprint', 0.42),
          ('TurnLeft', 0.8), ('TurnRight', 0.8), ('Dive', 0.7), ('Rise', 0.7),
          ('Attack', 0.2), ('Attack', 0.45), ('Bite', 0.1),
          ('Heavy', 0.3), ('Heavy', 0.6), ('Ability', 0.2), ('Ability', 0.45),
          ('Ability', 0.65), ('Crawl', 0.2), ('Crawl', 0.6), ('Crawl', 1.1),
          ('Hit', 0.3), ('Death', 1.4), ('Guard', 0.6), ('Parry', 0.2), ('Dodge', 0.25),
          ('Eat', 0.4), ('Stagger', 0.6), ('Grab', 0.55), ('Breath', 1.1), ('Breathe', 1.5),
          ('Growth', 0.75)]
TOP = [('Swim', 0), ('Swim', 0.24), ('Swim', 0.48), ('Swim', 0.72),
       ('Sprint', 0), ('Sprint', 0.14), ('Sprint', 0.28), ('Sprint', 0.42),
       ('Ability', 0.2), ('Ability', 0.45), ('Ability', 0.65), ('Crawl', 0.6)]
MOUTH = [('Idle', 0), ('Bite', 0.1), ('Heavy', 0.55), ('Eat', 0.4)]

C.run('aphaneramma', PHASES, TOP, MOUTH, mouth_scale=1.25)
