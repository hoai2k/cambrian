...
CLIPS={'Idle':3.2,'Swim':1.8,'Sprint':1.1,'TurnLeft':1.6,'TurnRight':1.6,'Dive':1.8,'Rise':1.8,'Attack':1.0,'Bite':.6,'Heavy':1.35,'Hit':.65,'Death':2.4,'Guard':2.6,'Parry':.65,'Dodge':.9,'Eat':2.4,'Stagger':1.5,'Ability':2.1,'Growth':2.2}
LOOPS=['Idle','Swim','Sprint','Guard','Eat']
...
def pose(clip,t,bones):
 ...
 effort={'Idle':.12,'Swim':1,'Sprint':1.55,'Guard':.10,'Eat':.14,'Ability':.17,'Growth':.15}.get(clip,.38)
