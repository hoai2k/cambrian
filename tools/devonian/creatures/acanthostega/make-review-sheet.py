...
root=Path(__file__).resolve().parents[4];local=root.parent/'devonian-authoring/acanthostega';out=local/'viewer-v1';names=['Idle','Swim','TurnLeft','TurnRight','Dive','Rise','Attack','Bite','Heavy','Hit','Death','Guard','Parry','Dodge','Eat','Stagger','Ability','Growth']
canvas=Image.new('RGB',(1500,900),'#132022');d=ImageDraw.Draw(canvas)
