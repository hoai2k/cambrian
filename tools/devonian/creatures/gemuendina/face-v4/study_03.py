...
OUT = ROOT.parent/'devonian-authoring/gemuendina/face-v4/study-03'
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'gemuendina-face-study-03.blend'))
report['blendSha256']=sha(OUT/'gemuendina-face-study-03.blend')
...
print('GEMUENDINA_FACE_STUDY_03_COMPLETE',flush=True)
