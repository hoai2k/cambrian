...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'gemuendina-face-production-01.blend'))
...
report={'phase':'local candidate; visual and post-rework audit pending','input_material_sha256':MATERIAL_SHA,
        'source_sha256':{str(p):sha(p)for p in [HERE/'candidate_01.py',HERE/'shape_02.py',HERE.parent/'rework-v3/rig_actions_01.py',HERE.parent/'rework-v3/sculpt_spec_02.py',HERE.parent/'rework-v3/filter_lod_pigment_02.py']},
...
print('GEMUENDINA_FACE_CANDIDATE_01_GROUP_OK '+str(OUT/'candidate-report.json'))
