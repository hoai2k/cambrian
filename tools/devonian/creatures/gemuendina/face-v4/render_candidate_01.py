...
import hashlib
ROOT=HERE.parents[4];OUT=ROOT.parent/'devonian-authoring/gemuendina/face-v4/candidate-01'
...
folder.mkdir();bpy.ops.wm.open_mainfile(filepath=str(OUT/'gemuendina-face-production-01.blend'));scene=bpy.context.scene
...
if args.group=='portraits':
    ...
    rows=[
      ...
      ('Heavy-front','Heavy',.45,(0,-5,.30),(0,-1.60,.05),1.9,False),
