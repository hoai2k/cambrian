...
import hashlib
ROOT=HERE.parents[4];OUT=ROOT.parent/'devonian-authoring/gemuendina/face-v4/candidate-02'
...
folder.mkdir();bpy.ops.wm.open_mainfile(filepath=str(OUT/'gemuendina-face-production-02.blend'));scene=bpy.context.scene
