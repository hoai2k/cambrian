...
OUT = ROOT.parent/'devonian-authoring/gemuendina/face-v4/study-02'
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'gemuendina-face-study-02.blend'))
report['blendSha256']=sha(OUT/'gemuendina-face-study-02.blend')
...
print('GEMUENDINA_FACE_STUDY_02_COMPLETE',flush=True)
