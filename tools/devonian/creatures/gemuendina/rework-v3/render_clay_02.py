"""Render the frozen four primary clay views; no creative mutations."""
...
from sculpt_spec_02 import VIEWS
PRIMARY_NAMES=('threequarter','front','side','dorsal')
VIEWS=[next(v for v in VIEWS if v[0]==name) for name in PRIMARY_NAMES]
...
blend=OUT/'gemuendina-clay-02.blend'
