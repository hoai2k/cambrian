...
ROOT=Path(__file__).resolve().parents[4];LOCAL=ROOT.parent/'devonian-authoring/cheirolepis';OUT=LOCAL/'v2-candidate';REVIEW=LOCAL/'final-review-v2';REVIEW=LOCAL/('lod-review-v2' if '--lod' in sys.argv else 'final-review-v2');REVIEW.mkdir(exist_ok=True)
