...
# Dedicated Cladoselache V2 anatomy and original mapped PBR materials.
...
if os.environ.get('CLADOSELACHE_QUICK'):
 ...
 cam.location=(9,0,.55);cam.rotation_euler=(Vector((0,.60,0))-cam.location).to_track_quat('-Z','Y').to_euler();render(os.path.join(LOCAL,'v2-side.png'),1000,750,False)
