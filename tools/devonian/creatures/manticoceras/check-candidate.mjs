// Shared intake snapshot with candidate-only input/output directories.
...
const root = '../devonian-authoring/manticoceras/intake-layout';
...
fs.mkdirSync('../devonian-authoring/manticoceras/intake-review',{recursive:true});
fs.writeFileSync('../devonian-authoring/manticoceras/intake-review/intake.json',JSON.stringify(results,null,2)+'\n');
