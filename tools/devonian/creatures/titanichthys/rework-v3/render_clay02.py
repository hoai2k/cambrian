"""Frozen multiview recipe for the unreviewed Titanichthys clay-02.
...
SOURCE = OUT/'titanichthys-clay-02.blend'
...
if hashlib.sha256((HERE/'build_clay02.py').read_bytes()).hexdigest() != report['builder_sha256']:
