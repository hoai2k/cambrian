"""Six matched actual-GLB normal-resolution comparison renders; no scene saves."""
...
OUT=LOCAL/'normal-render-study-02/renders';sys.dont_write_bytecode=True;sys.path.insert(0,str(HERE))
