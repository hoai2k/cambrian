/** Local lossless candidate06 study. No LOD stripping, quantization or public writes. */
...
const SRC=path.join(LOCAL,'candidate-06'),OUT=path.join(LOCAL,'packaging-study-candidate06-01');
...
await mkdir(OUT);
const report={scope:'Lossless local packaging study only; current art verdict HOLD. No public writes or animation stripping.',
