...
LOCAL=REPO.parent/'devonian-authoring/titanichthys/rework-v3';OUT=LOCAL/'candidate-03'
...
if OUT.exists():raise RuntimeError('Preserve existing candidate-03')
    ...
    for mat in ob.data.materials:
        for node in mat.node_tree.nodes:
            ...
            if name not in export_images:
                image=source.copy();image.name='Candidate03 '+source.name
...
blend=OUT/'titanichthys-production-03.blend';bpy.ops.wm.save_as_mainfile(filepath=str(blend))
...
source_names=('candidate_03.py','rig_actions_01.py','export_patch_01.py','metadata_seed_01.json','render_candidate_03.py','check_candidate_03.py','atlas_pigment_02.py','atlas_samples_02.json','lod_pigment_03.py')
