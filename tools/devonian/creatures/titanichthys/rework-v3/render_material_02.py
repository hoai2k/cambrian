...
OUT=REPO.parent/'devonian-authoring/titanichthys/rework-v3/material-02'
SOURCE=OUT/'titanichthys-material-02.blend'
...
if sha(HERE/'materials_02.py')!=report['material_script_sha256']:raise RuntimeError('Material authoring script changed')
...
if sha(report['imagegen_source'])!=report['imagegen_source_sha256']:raise RuntimeError('Original pigment source changed')
if sha(report['imagegen_provenance'])!=report['imagegen_provenance_sha256']:raise RuntimeError('Original pigment provenance changed')
