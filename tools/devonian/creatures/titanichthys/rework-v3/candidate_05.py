...
LOCAL=REPO.parent/'devonian-authoring/titanichthys/rework-v3';OUT=LOCAL/'candidate-05'
...
if OUT.exists():raise RuntimeError('Preserve existing candidate-05')
    ...
    for mat in ob.data.materials:
        for node in mat.node_tree.nodes:
            ...
            if name not in export_images:
                image=source.copy();image.name='Candidate05 '+source.name
...
blend=OUT/'titanichthys-production-05.blend';bpy.ops.wm.save_as_mainfile(filepath=str(blend))
...
source_names=('candidate_05.py','rig_actions_01.py','export_patch_02.py','metadata_seed_01.json','render_candidate_05.py','check_candidate_05.py','atlas_pigment_03.py','atlas_samples_02.json','lod_pigment_03.py')
