"""Frozen multiview recipe for the unreviewed Titanichthys clay-04.
...
SOURCE = OUT/'titanichthys-clay-04.blend'
...
if hashlib.sha256((HERE/'build_clay04.py').read_bytes()).hexdigest() != report['builder_sha256']:
