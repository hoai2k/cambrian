...
LOCAL=REPO.parent/'devonian-authoring/titanichthys/rework-v3';OUT=LOCAL/'candidate-04'
...
if OUT.exists():raise RuntimeError('Preserve existing candidate-04')
    ...
    for mat in ob.data.materials:
        for node in mat.node_tree.nodes:
            ...
            if name not in export_images:
                image=source.copy();image.name='Candidate04 '+source.name
...
blend=OUT/'titanichthys-production-04.blend';bpy.ops.wm.save_as_mainfile(filepath=str(blend))
...
source_names=('candidate_04.py','rig_actions_01.py','export_patch_02.py','metadata_seed_01.json','render_candidate_04.py','check_candidate_04.py','atlas_pigment_02.py','atlas_samples_02.json','lod_pigment_03.py')
