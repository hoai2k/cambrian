...
## 2026-09-08 — candidate07 bounded oral derivative frozen after resume

- Owner/model: Astra high. Status: candidate-ready SOURCE ONLY; final art HOLD. User resumed; prior pause superseded. Root owns separate actual eye classifier/seating and texture-size work. No Blender/public/Git/shared edits by author.
- Actual ray diagnostic inspected: canonical64 hits were only2 unique triangles with a repeated float32 local hit; independent float64 found2 forward/0 reverse crossings. Root subsequently measured true06 eye containment approximately41–42%, below50. Candidate07 preserves all eye and skull-influenced socket bytes for root's separate seating derivative; no eye approval claimed.
- Oral repair: shared physical rest-space depth field across both lower layers, broader1.50–2.56 jaw transition; local lower-floor mask, existing skull influences protected; maximum4 bones without truncation. Preserves24-degree Ability, all18/18 action bytes, rest geometry, pigment/PBR, triangle order, anchors and all non-body weights. Copies actual06 GLBs and changes only body joint/weight bytes; same rule saved to new07 blend. No full rebuild/decimation/export/textures.
- Source static validation:14,844 full and4,128 LOD vertices affected; max4 influences, dedicated accessor storage.5 AST parses; structural checker changes only candidate directory. Previous245 and final256 frozen entries reverified. No actual candidate07 execution or success yet.
- Freeze manifest `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/titanichthys/rework-v3/frozen-candidate-07.sha256` SHA `850f8fa928d9020b26df8fffce0db2eb0b08e901736b52698fd19cd755247159` (256 entries). Handoff `HANDOFF-CANDIDATE-07.md` SHA `e01f678739a11d3bef093d672209de68f9e00b75289a55acf1fe898d989f921c`. Builder SHA `3b2405eb9e2324bd7228c33543a92dc4c7a41745d79ae2ca74bb4acd5f8632b8`; field SHA `566a92c10be6585535ac3fc3bbeeb45cc66817c88c9f67cf2c74743ecaf6c1a0`. Target candidate-07 absent at freeze.
- Resume CWD `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo`; verify manifest first. Exact next command: `/Applications/Blender.app/Contents/MacOS/Blender --background --threads 2 --python-exit-code 1 --python /Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/titanichthys/rework-v3/candidate_07.py`. Then structural G2, unrounded58-pose/16-plane oral sweep G3, five actual imported-GLB oral views G4 as frozen. Initial bounds5/2/8/12minutes.
- G3 first reproduces known06 crossing, then requires zero strict underside/oral section crossings and no originalpatch underside-first rays at new maximumAbility. This is sampled oral evidence, not all-time wholemesh proof. First failure saves exact evidence and stops before renders. No threshold changes or alternative weights by executor.
- Return actual numerical/images to source author. Root eye/size derivatives follow separately after oral review; final oral/eye/general/runtime/packaging and public approval remain open. All06 and previous failures preserved.

## 2026-09-08 — candidate07 actual G3 stop; evidence-based region correction02 frozen

- Owner/model: Astra high. Status: candidate07 G1/G2 actual PASS, oral visual HOLD. G3-01 stopped fullAbility.5 after14 records on38/340 underside-first pixels; all16 sections at that pose had0 crossings. G4-01 not run. All failed evidence preserved.
- Independent read-only CPU evaluation proves the fixed screen rectangle included legitimate anatomy:07 has37 hits outside original geometric aperture; remaining triangle112663 is first lip collar, its new vertices only~.000506 from rim. Actual oral-material boundary (196 full/101LOD vertices, one closed loop, exact-position welding) classifies06 as46 interior underside hits,07 as0 interior/38 exterior. Closest07 excluded pixel7.2965e-5 outside inner lip. Actual saved hit reproduction errors≤1.10e-6, exact duplicate joint/weight maps checked full/LOD06/07. No08 geometry repair justified by this evidence.
- Corrected check_oral07_02 retains same58 poses/16 planes and byte-identical AST section/crossing logic/tolerances. Both06 baselines must detect old true interior inversion; actual posed oral-material boundary supplies ray region with no exclusion-distance threshold. All underside hits still recorded. Renderer02 differs only by new result/sweep directories. No model or material edits.
- Actual07 full SHA036df0da40265036decad16322e57694bc7a581156446cc556557b9370245e3a; LODf1251881583a6eb1ff559d55804ba5123eaccc805529d858644930dc60c49522; blende64023a65ad8be237c811f421a95bd9f1a4a5fa70c8220446100311d20115b1e. Root eye/normal studies are separate inputs and not substituted here.
- Manifest `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/titanichthys/rework-v3/frozen-oral07-check02.sha256` SHA `b8509378af4c88717229a96dc5174c0f18ac6ac051d85e96b08bda8013ccbb27` (277 entries). Handoff `HANDOFF-ORAL07-CHECK02.md` SHA `c0f009edcaf2d10a39221947c6bae89df29bd033215db88751abd59bd14cc183`. Checker SHA1c056d652b355a9f0da4483472fd276fef0443b61830f027d113920df99d0c16; helperbdc459af28e02a53bfbce4c25d57052d7b618c62aea05867818dd7448d5f24f6.
- Resume CWD `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo`; verify277 inputs then exact command `/Applications/Blender.app/Contents/MacOS/Blender --background --threads 2 --python-exit-code 1 --python /Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/titanichthys/rework-v3/check_oral07_02.py`. Target candidate-07/oral-sweep-02;8-minute initial bound. No G1/G2 rerun. Only afterpass run frozen renderer02 tooral-renders-02,12minutes. Root schedules around lowdisk condition.
- All277 inputs reverified; AST source checks passed. Only lightweight read-only arithmetic and smallsource/reports written by Astra; no Blender/heavywrites/public/Git. G3-02/G4-02 not executed. Remaining oral full/LOD sweep/art, root eye/size, runtime/general gates still pending.

## Root execution update —2026-09-08 18:56 UTC

G3-02 executed successfully: all58 actual full/LOD poses PASS with the exact
oral-material boundary, unchanged crossing tolerances. All277 frozen inputs verified
pre/post. Result candidate-07/oral-sweep-02/result.json SHA
4d44defd9df2bc288cb2fd504ff21ac6ba7fd942d313c4432c054ff79b0eb75f.
G4-02 not run: disk roughly219MiB free; user asked to free5–10GB. Original07
failed rectangular-region result remains preserved. No08 model rewrite needed.
Separate eyes-only study02 volume gate passes (lower60.32–61.68%), but initial
orbit renders use wrong duration/Bind reset and are invalid pose evidence. Terra
is preparing corrected source03, rendering deferred for disk. Normal-map study
package21,853,112B; head/body matched appearance reviewed, finaloral image save
failed. No public model changes or main integration yet this resumed block.

## 2026-09-08 — actual13-image creative review; assembly accepted

- Owner/model: Astra high. Status: ACCEPTED COMPONENTS FOR COMPOSITION; final assembled/public approval pending. Independently inspected all8 valid eyes02 orbital04 and all5 actual07 oral02 images. All image hashes and frame/slot conditions verified.
- Eyes: manifest3d26f671a4b8a331df6dd4c620d1122c750b44b38371c435e53198b890606851. Inward0.030 seating accepted. Pupil/catchlight remain visible, socket border continuous in Bind/Ability. Minor close LOD annular faceting is acceptable at intended distance. Lower95% bounds60.32–61.68 pass50;65 target not claimed. Earlier pose-invalid images are excluded.
- Oral: manifestf2b700a9c7779b157f443564ab16c78737f6a8bba633f62ffdb426cb05f53012. All5 full/LOD views accepted: pale interior patches gone; floor, thin rim and corners continuous; broad24-degree edentulous gape preserved. All58 sweep poses pass, SHA4d44defd9df2bc288cb2fd504ff21ac6ba7fd942d313c4432c054ff79b0eb75f. Old06 mouth in eye-only images and shallow eyes in oral-only images are excluded from the other component's approval.
- Root separately accepts normal-study02 matched head/body/oral pairs. Body normal2048 plus lossless other PNGs; body albedo4096 preserved. Study package21,853,112B is not the final assembly size.
- Creative report art-review-oral07-eyes02.json SHA `1b0510418a2e95be41aa79ccde32dc2cf2a1b457ad9290bbce6a74a7a3ba6e16`. Verdict ART-VERDICT-ORAL07-EYES02.md SHA `30c7c305e9d3a143dec5ec07d62fb5c7eb6c8f95489234b6b27b4b02648c48c7`. Assembly specification ASSEMBLY-SPEC-ORAL07-EYES02-NORMAL02.md SHA `dbf12ed291fb292a11d777db7efe54a4580462ea34a266867e9881796db45132`. All7 accepted assembly input hashes verified.
- Next: root authors/freezes/runs a new immutable assembly using07 oral weight bytes, eyes02 POSITION values and accepted normal-study image payloads. Preserve all18/18 actions, anchors, rig, colors and rest topology. Save equivalent editable07 blend with the exact eye-world deltas and accepted normal map. No full rebuild, action rebake, decimation or broad sculpt.
- Root retains final exact composition/structural proof, assembled eye/oral measurements and views, production portraits and actual runtime palette/required clips/held Death/LOD transition gates. No heavy job, local model mutation, public or Git edits by this author. All prior invalid/failed studies preserved.
