"""Export frozen candidate02 full/LOD locally. Never writes public or source Blend.
...
Q=R.parent/'devonian-authoring/dunkleosteus/face-v4/candidate02'
P=Q/'dunkleosteus-face-v4-candidate02.blend'
EXPECTED='9a686211386b44ca42b264b1f8c5c17bdf04d7b2b81d14ca2d6e702f87d78c83'
sha=lambda p:hashlib.sha256(Path(p).read_bytes()).hexdigest()
assert sha(P)==EXPECTED,'Candidate02 input mismatch'
OUT=Q/'exports';OUT.mkdir(exist_ok=True)
...
meta['artVersion']=4;meta['artCandidate']='face-v4-candidate02'
