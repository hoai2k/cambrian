...
Run after export_03.py in a separate Blender CPU2 process. Writes reports only.
...
assert not (Q/'eye-oral-audit-summary.json').exists(), 'Refuse to overwrite prior audit summary'
assert not list(Q.glob('*-eye-oral-audit.json')), 'Refuse to reuse prior model audit reports'
