...
H=Path(__file__).resolve().parent;R=H.parents[3];L=R.parent/'devonian-authoring/nahecaris';C=L/'initial-candidate';lod='--lod'in sys.argv;preview='--preview'in sys.argv
