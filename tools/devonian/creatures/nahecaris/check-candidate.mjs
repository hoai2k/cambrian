...
const root = '../devonian-authoring/nahecaris/intake-layout';
...
fs.mkdirSync('../devonian-authoring/nahecaris/intake-review',{recursive:true});
fs.writeFileSync('../devonian-authoring/nahecaris/intake-review/intake.json',JSON.stringify(results,null,2)+'\n');
