...
const root = process.env.NAHE_CHECK_ROOT || '../devonian-authoring/nahecaris/intake-layout';
...
const reviewDir = process.env.NAHE_CHECK_ROOT ? `${root}/../intake-review` : '../devonian-authoring/nahecaris/intake-review';
