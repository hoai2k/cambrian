...
anchors=[('anchor_mouth','body',(0,-.90,-.185),'mouth'),('anchor_mouth_inside','body',(0,-.90,-.098),'swallow'),('anchor_attack_primary','cheliceraL2',(.75,-3.12,0),'attack'),('anchor_grasp_left','cheliceraL2',(.665,-2.83,.009),'grasp'),('anchor_grasp_right','cheliceraR2',(-.665,-2.83,.009),'grasp')]
...
bpy.context.view_layer.update();(H/'anchors.json').write_text(json.dumps({'jaekelopterus':[{'name':n,'bone':b,'point':p,'role':r}for n,b,p,r in anchors]},indent=2))
sourcepath=L/'jaekelopterus-initial.blend';bpy.ops.wm.save_as_mainfile(filepath=str(sourcepath))
def export(path):
