"""Linux copy of render_clay01.py.  Deltas: threads 2 -> 1; it verifies the
inputHashes construction.json actually recorded (the -linux script names).
Camera rig, lighting, samples, resolution and the seven views are unchanged.
"""
import bpy
import json
import hashlib
