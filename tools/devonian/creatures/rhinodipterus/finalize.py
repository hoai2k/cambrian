...
import numpy as np
H=Path(__file__).resolve().parent;R=H.parents[3];O=R.parent/'devonian-authoring/rhinodipterus/v2-candidate'
...
for suffix in ['','.lod1']:
 ...
 manifest=json.loads((H/'anchors.json').read_text())['rhinodipterus']
 for s in manifest:
