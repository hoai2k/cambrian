...
BAKE=ROOT/'baked-02';OUT=ROOT/'candidate-03'
SOURCE_NAMES=('production_common_03.py','bake_02.py','body_uv_02.py','atlas_pigment_01.py','rig_actions_01.py','candidate_03.py','export_patch_02.py','render_candidate_03.py','check_candidate_03.py','check_export_atlas_03.py','metadata_seed_01.json')
...
def verify():
    ...
    for row in json.loads((HERE/'frozen-candidate-03.json').read_text())['inputs']:
