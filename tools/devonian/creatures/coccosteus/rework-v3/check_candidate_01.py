...
OUT=ROOT.parent/'devonian-authoring/coccosteus/rework-v3/candidate-01'
sys.dont_write_bytecode=True;sys.path.insert(0,str(HERE))
from rig_actions_01 import CLIPS,LOOPS,ANCHORS,bones
from production_common_01 import verify
verify()
...
for suffix in ('','.lod1'):
    ...
    assert set(names)==({'Idle','Swim','Death'}if suffix else set(CLIPS))
