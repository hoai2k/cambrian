...
BAKE=ROOT/'baked-01';OUT=ROOT/'candidate-01'
SOURCE_NAMES=('production_common_01.py','bake_01.py','atlas_pigment_01.py','rig_actions_01.py','candidate_01.py','export_patch_01.py','render_candidate_01.py','check_candidate_01.py','metadata_seed_01.json')
...
def verify():
    ...
    for row in json.loads((HERE/'frozen-candidate-01.json').read_text())['inputs']:
