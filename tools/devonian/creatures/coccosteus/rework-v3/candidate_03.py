...
OUT.mkdir();bpy.ops.wm.open_mainfile(filepath=str(BAKE/'coccosteus-baked-02.blend'));scene=bpy.context.scene
...
blend=OUT/'coccosteus-production-03.blend';bpy.ops.wm.save_as_mainfile(filepath=str(blend))
...
print('COCCOSTEUS_CANDIDATE_03_COMPLETE',flush=True)
