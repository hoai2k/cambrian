...
BAKE=ROOT/'baked-03';OUT=ROOT/'candidate-04'
SOURCE_NAMES=('production_common_04.py','bake_03.py','body_uv_02.py','atlas_pigment_01.py','rig_actions_01.py','candidate_04.py','export_patch_02.py','render_candidate_04.py','check_candidate_04.py','check_export_atlas_04.py','metadata_seed_01.json')
...
def verify():
    ...
    for row in json.loads((HERE/'frozen-candidate-04.json').read_text())['inputs']:
