# Coccosteus production candidate-02 — retain every required LOD action

This versioned amendment retains all 18 existing actions in both full and LOD exports.
Original candidate-01 sources, freeze manifest and handoff are preserved byte-for-byte.
No geometry, material, rig, weight, motion curve or decimation change. The only behaviour
change is removal of LOD clip pruning, with matching structural checks and two extra actual
LOD Attack/Eat views. Versioned output is candidate-02; original candidate-01 is not reused.

**Bake compatibility:** Group 1 is the unchanged bake_01.py with its original frozen dependencies.
If baked-01 already completed successfully, verify its original recorded blend/report/texture
hashes and skip Group 1. candidate_02.py accepts that exact old-source bake report while also
verifying this new manifest; no bake rerun or source-report rewriting is needed.
...
Manifest: `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/frozen-candidate-02.json`.
Manifest SHA-256: `a2cf3f2ff14f2124032882b885d46db5c05e1a3c5a47f1aef5f5ac9d71772bfd`.
Verify its hash and all 22 listed input hashes before each group. These include every old
input, both original frozen documents, and the five new versioned sources. Any mismatch stops.
...
| `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/production_common_02.py` | `67be26bae9205222819555dc753f76c5c4dc3bf231787d8ca1eaf061babbcc55` |
| `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/candidate_02.py` | `c1a2d1c9c7b5bb7017ef166df43f6123a310803691d6a36fe0d06ef400d1a156` |
| `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/export_patch_02.py` | `933ba01dcac26b7e2d8d9cecae85dffb29408728f63c896345aed19ea54b602f` |
| `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/render_candidate_02.py` | `1c3b2cb40df977356c8ef18d0f0791713de64548b0637b23ec0877ab210f83c6` |
| `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/check_candidate_02.py` | `75286ec7713c5f3af8d302fdf7a86de06fd361b7949ca27da829ea605feb47f6` |
| `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/frozen-candidate-01.json` | `136479902de636c03a4807bc755bef638f67aaebc20568012e4c15328df1439d` |
| `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/HANDOFF-CANDIDATE-01.md` | `dc762ce297a01350c34849d474bbb57716ea692367507184c6720988894b6ab0` |

CWD for all groups: `/Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo`.
Candidate-02 does not exist yet; baked-01 may already have completed under the original handoff.
Each new group has an exclusive destination and refuses to
...
```sh
/Applications/Blender.app/Contents/MacOS/Blender --background --threads 2 --python-exit-code 1 --python /Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/candidate_02.py
```

Expected exit zero and `COCCOSTEUS_CANDIDATE_02_COMPLETE`. Budget 30 minutes.
Exclusive output: `/Users/hoai/Documents/Stuff/Generations/cambrian/local/devonian-authoring/coccosteus/rework-v3/candidate-02`.
Expected `coccosteus-production-02.blend`, `coccosteus.glb`, `coccosteus.lod1.glb`,
...
- Full export carries embedded PBR maps and white COLOR_0. LOD uses .25 body, .70 eye and .24 fin
  ...
  LOD retains all 18 identical required actions and uses texture-free linear vertex pigment.
...
```sh
/usr/bin/python3 /Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/check_candidate_02.py
```

Expected exit zero and `COCCOSTEUS_EXPORT_STRUCTURE_PASS`. Budget 5 minutes.
Writes only `candidate-02/export-structural-review.json`. Must confirm all 18 distinct full
clips with matching durations and dynamic skull/jaw channels, all 18 reduced clips, finite
...
```sh
/Applications/Blender.app/Contents/MacOS/Blender --background --threads 2 --python-exit-code 1 --python /Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/render_candidate_02.py -- --group portraits
```

Expected exit zero and `COCCOSTEUS_CANDIDATE_PORTRAITS_COMPLETE`. Budget 20 minutes.
Four new outputs in candidate-02: `coccosteus.select.png` (1600x1200 transparent),
...
```sh
/Applications/Blender.app/Contents/MacOS/Blender --background --threads 2 --python-exit-code 1 --python /Users/hoai/Documents/Stuff/Generations/cambrian/local/expansion-repo/tools/devonian/creatures/coccosteus/rework-v3/render_candidate_02.py -- --group review
```

Expected exit zero and `COCCOSTEUS_CANDIDATE_REVIEW_COMPLETE`. Budget 35 minutes.
19 new views and complete `pose-evidence/manifest.json`: four rest body views and armour close,
Heavy open mouth, Eat front, closing Bite, Swim, TurnLeft, Dodge, Death, two orbit angles,
actual LOD oblique/Swim/Attack/Eat and neutral LOD geometry. These use actual imported GLB actions.
...
## Amendment source validation

All five new Python sources parse. A pure minimal-GLB test exercised the versioned patch
function with lod=False and lod=True: both preserve the exact ordered 18-clip list. The
versioned structural checker expects all 18 clips for each detail level and tests dynamic
jaw/skull channels for Bite, Eat and Ability in BOTH exports. Two actual LOD Attack/Eat
renders specifically expose the regression this amendment prevents. No Blender was invoked.
The original 15-input freeze and original handoff were independently reverified unchanged.
