...
export const MANIFEST = [
  ...
  ['disintegrate', 'a tiny creature crumbling into a cloud of drifting particles underwater, bright fine sparkling hiss and delicate crystalline tinkles scattering outward and fading, airy, no music, no drone', 1.0, 1],
  ...
  ['ui-start', 'warm inviting underwater game-start swell: a soft deep whoomp then a smooth rising three-note flourish on mellow rounded tones, energetic but gentle, no harsh transients', 1.8, 1],
