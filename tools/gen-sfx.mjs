...
const LOW_INFLUENCE = new Set(['grab', 'guard-break', 'ability', 'disintegrate', 'dodge', 'heartbeat', 'escape', 'ui-start', 'crunch', 'silt',
  'hit-huge', 'crunch-huge', 'surge-huge', 'sweep-huge', 'death-huge', 'breach', 'splash-down', 'surface-roll']);
...
export const MANIFEST = [
  ...
  // Big bodies. The Devonian roster runs 4-11.5 m against the Cambrian's 1-3.9 m, so the top of
  // the roster gets its own take of the sounds where mass reads (HUGE_LENGTH in src/audio/mix.ts).
  ['hit-huge', 'two enormous armoured fish collide underwater: a deep heavy body slam with a thick bony boom, heavy plates knocking, water thumping and a burst of big bubbles, huge and close, present clear midrange, no metal, no ring, no music', 1.0, 2],
  ['crunch-huge', 'enormous bony jaw plates grind through a mouthful underwater: slow heavy wet crunching and splintering, deep and dense, a few big bubbles, huge, close and detailed, clear midrange, no music', 1.1, 1],
  ['surge-huge', 'an enormous fish accelerates from a standstill underwater: a deep heavy surge of displaced water building and rolling past, a low thick whoomp with streaming bubbles, huge and close, present clear midrange, no wind, no air whoosh, no music', 1.3, 1],
  ['sweep-huge', 'an enormous tail sweeps hard through water: one deep heavy whump of displaced water with a thick low swirl and a burst of big bubbles, huge, close and present, clear midrange, no wind, no air whoosh, no music', 0.8, 1],
  ['death-huge', 'an enormous fish goes limp and sinks underwater: a long low groaning body creak, slow heavy water rolling around it, sparse big bubbles rising, huge and close, present clear midrange, no music', 2.0, 1],
  // The surface. Bodies are clamped just under it, so "breaching" is a body hitting it from below.
  ['breach', 'an enormous fish bursts up through the water surface from below: water tears open with a big rushing whoosh, heavy spray thrown into the air and a broad slapping splash, close and present, clear midrange, no music', 1.4, 2],
  ['splash-down', 'a huge body falls back into the sea and lands flat: a hard heavy slap on the water, then a deep churning collapse and foaming bubbles settling, close and present, clear midrange, no music', 1.6, 2],
  ['surface-roll', 'a large fish rolls at the water surface: a soft wet break of the surface, water sheeting off its back and dripping, small lapping waves and a few bubbles, close and present, gentle, clear midrange, no music', 1.0, 1],
