"""Rebuild the inactive Devonian brand pack: python3 tools/art/devonian/export.py."""
...
(OUT / 'manifest.json').write_text(json.dumps(dict(era='devonian', status='ready-inactive',
